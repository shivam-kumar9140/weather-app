...
## ✨Credits
`WeatherApp` is developed and maintained by `shivam`. Weather data is retrieved from the [OpenWeatherMap API](https://openweathermap.org/).

## 📧Contacts
For any inquiries or feedback, please contact [Here](mailto:akshivam2700@gmail.com).
